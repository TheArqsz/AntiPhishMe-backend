...
from antiphishme.src.api_modules.safebrowsing import lookup_url, SafeBrowsingException
from antiphishme.src.api_modules.levenstein import levenstein_check
from antiphishme.src.api_modules.entropy import get_entropy
from antiphishme.src.api_modules import urlscan
from antiphishme.src.api_modules.keywords import match_keyword
import antiphishme.src.api_modules.whois_module as whois
import antiphishme.src.api_modules.crtsh as crtsh
import antiphishme.src.api_modules.cert_hole as ch
...
from antiphishme.src.helpers import db_helper as db_h
...
def verify_levenstein(domain):
    ...
    # Transform example.com.pl to ['example', 'com']
    domain_phrases = domain.split('.')[:-1]
